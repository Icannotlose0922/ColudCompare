#ifndef RANDOMCUT_PLUGIN_HEADER
#define RANDOMCUT_PLUGIN_HEADER
...
**/
class ConvexHullPlugin2D : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
		...
		Q_PLUGIN_METADATA(IID "cccorp.cloudcompare.plugin.custom.ConvexHullPlugin2D" FILE "../info.json")

public:
	explicit ConvexHullPlugin2D(QObject* parent = nullptr);
	~ConvexHullPlugin2D() override = default;
