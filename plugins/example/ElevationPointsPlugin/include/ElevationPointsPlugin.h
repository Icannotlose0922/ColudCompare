#ifndef ELEVATION_PLUGIN_HEADER
#define ELEVATION_PLUGIN_HEADER
...
//! Example qCC plugin
/** Replace 'ElevationPointsPlugin' by your own plugin class name throughout and then
	check 'ElevationPointsPlugin.cpp' for more directions.
...
**/
class ElevationPointsPlugin : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
		...
		Q_PLUGIN_METADATA(IID "cccorp.cloudcompare.plugin.ExamplePoints" FILE "../info.json")

public:
	explicit ElevationPointsPlugin(QObject* parent = nullptr);
	~ElevationPointsPlugin() override = default;
