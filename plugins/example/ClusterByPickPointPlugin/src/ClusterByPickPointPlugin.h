#ifndef TESTPLUGIN_HEADER
#define TESTPLUGIN_HEADER
...
**/
class ClusterByPickPointPlugin : public QObject, public ccStdPluginInterface		//继承插件接口
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA(IID "cccorp.cloudcompare.plugin.ClusterByPickPointPlugin" FILE "../info.json")
	
public:
	explicit ClusterByPickPointPlugin( QObject *parent = nullptr );
	~ClusterByPickPointPlugin() override = default;
	
	// inherited from ccStdPluginInterface，重载了下面两个函数
	void onNewSelection( const ccHObject::Container &selectedEntities ) override;
	QList<QAction *> getActions() override;
	
private:
	/*** ADD YOUR CUSTOM ACTIONS HERE ***/
	void doAction();		//这里是真正添加我们自定义内容的地方
