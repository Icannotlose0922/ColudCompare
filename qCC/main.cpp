...
int main(int argc, char **argv)
{
	...
	if (commandLine)
	{
		...
		QString langFilename = "CloudCompare_chs.qm";

		if (translator.load(/*langFilename, QCoreApplication::applicationDirPath()+*/
			"K:/workspace/2022/project/3D/CloudCompare-master/build/qCC/Debug/translations/CloudCompare_chs.qm"))
		{
			bool t=qApp->installTranslator(&translator);
			int a = 3;
		}
		else
		{
